...
<form name="f1" method="post" action="mpassword.asp" style="position:relative;left:5%;top:5%;font-size:30px;font-family:Calibri;">
<table style="padding-left:100px;">
<tr colspan="2" height=50>
<b style="color:#242544;">Modify Manager Account</b>
</tr>
<%
set con=server.createobject("ADODB.Connection")
set rs=server.createobject("ADODB.Recordset")
con.open "rsbs"
sql="select * from manager where userid='"&session("mid")&"'"
rs.open sql,con,2,2
%>
<tr height=30 style="font-size:18px;">
<td style="padding-top:30px;">User Id</td>
<td style="padding-top:30px;"><input type="text" readonly name="t1" value="<%=rs.fields(0)%>"></td>
</tr>
<tr height=30 style="font-size:18px;">
<td>Password</td>
...
<tr height=30 style="font-size:18px;">
<td>User Name</td>
<td><input type="text"  name="t3" value="<%=rs.fields(2)%>"></td>
</tr>
<tr height=30 style="font-size:18px;">
<td>User Address</td>
<td><input type="text" name="t4" value="<%=rs.fields(3)%>"></td>
</tr>
<tr height=30 style="font-size:18px;">
<td>Mobile No</td>
<td><input type="text" name="t5" value="<%=rs.fields(4)%>"></td>
</tr>
<tr height=30>
...
window.open("mpassword.asp","_self")
</script>
<%
rs.close
con.close
