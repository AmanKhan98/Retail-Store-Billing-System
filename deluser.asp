...
<form method="post" action="deluser.asp" style="position:relative;left:5%;top:5%;font-size:30px;font-family:Calibri;">
<table style="padding-left:100px;">
<tr colspan="2" height=50>
<b style="color:#242544;">Delete User Account</b>
<p style="font-size:16px;color:#242544;">(Enter the User ID of the account you want to delete.)<p></tr>
...
<input style="background-color:#474866;color:#F0F0F0;" type="submit" value="Delete User" onmouseover="this.style.backgroundColor='#5F6188'" 
